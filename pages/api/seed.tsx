...
export default async function handler(
  ...
  await prisma.restaurent.deleteMany();
  ...
  const cuisines = await prisma.cusine.findMany();
  ...
  await prisma.item.createMany({
    data: [
      ...
      },
      {
        ...
        price: "$12.00",
        restaurent_id: lastTrainToDelhiId,
      },
      {
      ...
      },
      {
        ...
        price: "$18.00",
        restaurent_id: adrakYorkvilleId,
      },
      {
        name: "papad ki tokri",
      ...
      },
      {
        ...
        price: "$32.00",
        restaurent_id: curryishTavernId,
      },
      {
      ...
      },
      {
        ...
        price: "$8.99",
        restaurent_id: kamasutraIndianId,
      },
      {
      ...
      },
      {
        ...
        price: "$24.00",
        restaurent_id: canoRestaurantId,
      },
      {
